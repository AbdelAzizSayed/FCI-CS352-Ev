  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>HashTag Options </span></h2>
            <div class="clr"></div>
			<br>
						
			<br> <br>
			
			<form action="/social/getHashtagTimeline" method="post">
				search for a hashtag :<br> <input type="text" name = "HashtagName"></input><br><br>
			     <input type = "submit" value="Search">
			</form>
			
			<br> <br>
			
			<h2><span>Hashtag Trends (Top 10 HashTags)</span></h2>
            <div class="clr"></div>
			<br>
				<c:forEach items = "${it}" var = "cur"  >
				    <c:out value="${cur.Name}"/> : <c:out value="${cur.noOfPosts}"/></a><br>
