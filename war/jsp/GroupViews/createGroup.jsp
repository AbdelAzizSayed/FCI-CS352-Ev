        ...
        <div class="mainbar">
          <div class="article">
			...
			<br>
			  ...
			  Description :<br> <textarea rows="5" cols="21" name = "desc"></textarea> <br>
			  Privacy :<br> <select name = "privacy">
        ...
        <div class="sidebar">
          <div class="gadget">
            ...
            <ul class="sb_menu">              
			  ...
			  <li><a href="/social/sendGroupMessage/">Send Group Message</a></li>            </ul>
          </div>
        </div>
